        ...
        function requestFn() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (searchBtnClc) {
                        console.log("searchBtnClc TRUE", searchBtnClc);
                        results.html(getResultHtml(data.items)); //creating new result html
                    } else {
                        console.log("searchBtnClc FALSE", searchBtnClc);
                        results.append(getResultHtml(data.items)); //appending more results
                    }
        ...
        function checkScrollPos() {
            if (location.search.indexOf("scroll=infinite") > -1) {
                ...
                if (hasScrolledToBottom) {
                    console.log(" user bottom is true");
                    if (nextUrl) {
                        console.log(" next url exists");
                        requestFn();
